...
const projects = [
  ...
  },
  {
    ...
    link:'https://admin.upfafrica.org/login',
  ...
  ,
  {
    ...
    link:'https://frontend-diabetes.vercel.app/login',
          ...
          {projects.map((project) => (
            <div key={project.id} className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className='mt-6'>
                <h1 className='font-bold'>Links:<a href={project.link} className="text-gray-600 hover:text-gray-800 ml-3">
                {project.title}.com
              </a></h1>
              </div>
                <div className="mt-4">
